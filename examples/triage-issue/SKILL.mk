...
target: readme capture explore identify_fix tdd_plan create_issue
---
...
explore: readme capture
	...
	$git log on relevant files for recent changes
	- Error handling in the code path
	- Similar patterns elsewhere in the codebase that work correctly

identify_fix: explore
...
tdd_plan: identify_fix
	...
	- Only suggest fixes that would survive radical codebase changes. Describe behaviors and contracts, not internal structure. Tests assert on observable outcomes (API responses, UI state, user-visible effects), not internal state. A good suggestion reads like a spec; a bad one reads like a diff.

create_issue: tdd_plan
	Create a GitHub issue using `gh issue create`. Do NOT ask the user to review before creating - just create it and share the URL.
